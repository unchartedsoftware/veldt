...
func (v *Validator) Validate(arg interface{}) (tile.Generator, error) {
	generator := v.validateToken(arg, 0)
	err := v.Error()
	if err != nil {
		return nil, err
	}
...
func (v *Validator) validateTile(arg map[string]interface{}, indent int) tile.Generator {
	...
	generator, err := tile.GetGenerator(id, params)
	if err != nil {
...
func (v *Validator) validateToken(arg interface{}, indent int) tile.Generator {
	// tile
